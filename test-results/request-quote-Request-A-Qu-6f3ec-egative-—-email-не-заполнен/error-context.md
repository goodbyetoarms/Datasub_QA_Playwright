...
- Name: Request A Quote form tests >> Negative — email не заполнен
- Location: C:\Users\user\Documents\GitHub\Datasub_QA_Playwright\tests\request-quote.spec.ts:21:7
...
Locator: locator('#email:invalid')
Expected: 1
Received: 0
Call log:
  - expect.toHaveCount with timeout 5000ms
  - waiting for locator('#email:invalid')
    9 × locator resolved to 0 elements
      - unexpected value "0"

    at C:\Users\user\Documents\GitHub\Datasub_QA_Playwright\tests\request-quote.spec.ts:28:50
```
...
- combobox:
  ...
  - option "Select C Service" [selected]
  - option "Select D Service"
- text: "Account Purpose:"
- radio "Business"
- text: Business
- radio "Personal" [checked]
- text: "Personal Withdrawal Options:"
- checkbox "Cash"
- text: Cash
- checkbox "Card" [checked]
- text: Card
- checkbox "Cryptocurrency"
- text: Cryptocurrency
- textbox "Message": No email provided
